k1=6
k2=5
# p=k=No. of periods and b=n=No. of blocks=v*NB
v=20
y= 0
...
#Set of shifts  
T=c(3,5,6,7,18) #First set of shifts
T1=c(8,9,9,10) # Second and so on . . . .
#T2=c(12,13,14,32)
#T3=c(7,9,17)
#T4=c(6,17,22)
#T5=c(1,2,3,4,5,7,10,14)
#T6=c(3,25)
#T7=c(3,5,12,14)
#T8=c(2,5,36,37)
#T9=c(3,13,33,34)
